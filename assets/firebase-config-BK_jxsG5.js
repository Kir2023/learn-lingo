 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Mc(n){const e=Nt(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function i0(n,e,t){if(we(n.app))return Promise.reject(Fe(n));const r=Nt(n),o=await rs(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Yp).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&Mc(n),l}),a=await St._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(a.user),a}function s0(n,e,t){return we(n.app)?Promise.reject(Fe(n)):Xp(te(n),an.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&Mc(n),r})}function Zp(n,e,t,r){return te(n).onIdTokenChanged(e,t,r)}function e_(n,e,t){return te(n).beforeAuthStateChanged(e,t)}function o0(n){return te(n).signOut()}const Ir="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zT(n){$b(on),Xt(new It("database",(e,{instanceIdentifier:t})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return UT(r,i,s,t)},"PUBLIC").setMultipleInstances(!0)),Qe(fl,pl,n),Qe(fl,pl,"esm2017")}$e.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};$e.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};zT();const GT="AIzaSyDx2zsvJDlm6oZxzyhdjCVbj-9umos0TTE",qT="learn-lingo-ece72.firebaseapp.com",KT="learn-lingo-ece72",YT="learn-lingo-ece72.appspot.com",QT="1037640854706",JT="1:1037640854706:web:4ea7b22ea254e2bece6dab",XT="https://learn-lingo-ece72-default-rtdb.europe-west1.firebasedatabase.app/",ZT={apiKey:GT,authDomain:qT,projectId:KT,storageBucket:YT,messagingSenderId:QT,appId:JT,databaseURL:XT},ed=cc(ZT),g0=dg(ed),m0=WT(ed);export{c0 as E,a0 as F,Ed as G,r0 as M,Ab as a,i0 as b,Mb as c,g0 as d,l0 as e,o0 as f,m0 as g,f0 as h,d0 as i,Vr as j,h0 as k,PT as l,p0 as o,_0 as q,u0 as r,s0 as s,n0 as u};
